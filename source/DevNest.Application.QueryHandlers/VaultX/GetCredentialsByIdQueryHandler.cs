...
namespace DevNest.Application.QueryHandlers.VaultX
{
    /// <summary>
    ...
    public class GetCredentialsByIdQueryHandler(
        ...
        IVaultXDomainService domainService) : IQueryHandler<GetCredentialsByIdQuery, AppResponse<CredentialResponseDTO>>
    {

...
namespace DevNest.Application.QueryHandlers.Credentials
{
    ...
    /// </summary>
    public class GetCredentialsQueryHandler : IQueryHandler<GetCredentialsQuery, AppResponse<IEnumerable<CredentialsResponseDTO>>>
    {
        ...
        /// <returns></returns>
        public async Task<AppResponse<IEnumerable<CredentialsResponseDTO>>> Handle(GetCredentialsQuery query, CancellationToken cancellationToken = default)
        {

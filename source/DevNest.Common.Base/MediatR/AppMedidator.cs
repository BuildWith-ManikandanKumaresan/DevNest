...
namespace DevNest.Common.Base.MediatR
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="AppMedidator"/> class with the specified MediatR mediator.
    /// </remarks>
    /// <param name="mediator"></param>
    /// <exception cref="ArgumentNullException"></exception>
    public class AppMedidator(IMediator mediator) : IAppMedidator
    {

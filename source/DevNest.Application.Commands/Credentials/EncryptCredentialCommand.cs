...
namespace DevNest.Application.Commands.Credentials
{
    ...
    public class EncryptCredentialCommand(Guid credentialId, string workSpace) : CommandBase, ICommand<AppResponse<CredentialResponseDTO>>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the workspace associated with the credential.
        /// </summary>
